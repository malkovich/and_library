...
type
    ...
    protected
        ...
        FCtrlWindow    : HWND;
        FCommand       : array [0..$4000-1] of char;
        FCmdLen        : Integer;
        FPeerName      : String;
...
function TServerObject.ServerName:String;
begin 
  result := 'default server title';
end;
...
var
    ...
    Client : TClientObject;
begin
    DBG(ServerName + '有 ' + IntToStr(FCliList.Count) + ' 个连接的客户端。');
...
//    FCliWSocket.LineLimit       := 3 * 1024 * 1024;
    ...
    FCliWSocket.SendStr('Welcome to ' + TServerObject(FServerObject).ServerName + CmdPrompt);
end;
