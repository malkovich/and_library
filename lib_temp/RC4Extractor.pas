...
const
  GUID_SAMPLE_STRING = '{26D7A28F-8F72-40CC-8749-08B8838CAF60}';
  GUID_SAMPLE_LENGTH = Length(GUID_SAMPLE_STRING);

type
  TGUIDStr = array[0..GUID_SAMPLE_LENGTH]of char;
  TGuidTicket = TGUIDStr;
  TGuidRc4Key = TGUIDStr;

  LPTRC4Context = ^TRC4Context;
