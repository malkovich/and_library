...
function FileMD5Str(FileName: string): string;
function BufferMD5Str(Buffer: PChar; Size: Integer): string;
function StringMD5Str(Data: String): String;
...
begin
  ...
  try
    ...
    MD5Update(Context, MM.Memory, MM.Size);
  finally
    MM.Free;
  end;       
